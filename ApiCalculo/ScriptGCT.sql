...
INSERT INTO `modelo_componente` (`modelo`, `fabricante`, `fk_servidor`, `fk_componente`)
VALUES
('Intel Core i7 13700K', 'Intel', 1, 1),
('AMD Ryzen 7 7800X', 'AMD', 1, 1),
('Apple M1 Max', 'Apple', 1, 1),
('DDR4 3200MHz 16GB', 'Corsair', 1, 2),
('DDR5 4800MHz 32GB', 'G.Skill', 1, 2),
('LPDDR5 6400MHz 64GB', 'Samsung', 1, 2),
('Samsung 980 Pro 1TB', 'Samsung', 1, 3),
('WD Black SN850 2TB', 'Western Digital', 1, 3),
('Seagate FireCuda 530 4TB', 'Seagate', 1, 3);
